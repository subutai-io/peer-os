...
And the user enters node name: 'keshig'
...
And the user clicks on the button: Environment
And the user selects current environment
And the user selects container one in select menu
And the user enters console command: 'ping management -c 3'
Then the user verifies output console command and observe expected phrase: '3 packets transmitted, 3 received, 0% packet loss'
...
And the user runs bash script: resets virtual box and deletes vagrant directory