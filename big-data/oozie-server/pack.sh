...
BASE="/var/lib/jenkins/jobs/master.bigdata.oozie-server/Oozie-server"
SOURCE="/var/lib/jenkins/jobs/master.bigdata.oozie-server/workspace/big-data/oozie-server/oozie-server"
