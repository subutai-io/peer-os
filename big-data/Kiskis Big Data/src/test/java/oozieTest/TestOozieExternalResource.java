...
public class TestOozieExternalResource {
    ...
    @ClassRule
//    public static TestRule chain= RuleChain.outerRule(pigExternalResource).around(oozieExternalResource);
    public static TestRule chain= RuleChain.outerRule(hadoopExternalResource).around(pigExternalResource).around(oozieExternalResource);
