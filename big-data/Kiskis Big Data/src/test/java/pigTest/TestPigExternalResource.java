...
public class TestPigExternalResource {
    ...
    static ArrayList<MyExternalResource> resources = new ArrayList<MyExternalResource>();

//    @ClassRule
//    public static OrderExternalResources orderExternalResource = new OrderExternalResources(hadoopResource, pigResource);
