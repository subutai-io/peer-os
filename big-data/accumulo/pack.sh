...
BASE="/var/lib/jenkins/jobs/master.bigdata.accumulo/Accumulo"
SOURCE="/var/lib/jenkins/jobs/master.bigdata.accumulo/workspace/big-data/accumulo/accumulo"
...
mv accumulo-1.4.2 $fileName/opt/
