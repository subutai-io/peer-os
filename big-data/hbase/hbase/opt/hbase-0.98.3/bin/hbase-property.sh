...
usage()
{
        ...
        echo "Example: $0 add hbase-site.xml hbase.master master:60000"
        echo "Example: $0 remove hbase-site.xml hbase.master"
        exit 1
}
. /etc/profile
add_prop="";
...
hbaseConf="/etc/hbase"
if [[ "x$HBASE_CONF_DIR" != "x" ]];
then
        hbaseConf=$HBASE_CONF_DIR
fi

fileName="$hbaseConf/$2"
