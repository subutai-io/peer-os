...
public class UsApplicant implements Converter{
	...
	public UsApplicant(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
		addressBooks = new ArrayList<AddressBook>();
		usRightss = new ArrayList<UsRights>();
		...
		for (int i=0; i < attributes.size(); i++)
		{
			...
			else if (attribute.getName().equals("applicant-authority-category")) {
				applicantAuthorityCategory = attribute.getValue();
			}
			else
			{
