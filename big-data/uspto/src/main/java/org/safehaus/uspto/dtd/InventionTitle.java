...
public class InventionTitle extends SingleCollection<Converter>{

	protected Logger logger;
	
	private static final String title = "InventionTitle";
	
	private String id;
	private String language;
	
	public InventionTitle(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public InventionTitle(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public InventionTitle(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
