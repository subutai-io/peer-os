...
public class ContinuationInPart implements Converter{

	private static final String title = "ContinuationInPart";
	
	protected Logger logger;
	
	private Relation relation;
	
	public ContinuationInPart(Logger logger) {
		this.logger = logger;
	}

	public ContinuationInPart(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public ContinuationInPart(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
