...
public class Reissue implements Converter{

	private static final String title = "Reissue";
	
	protected Logger logger;
	
	private Relation relation;
	
	public Reissue(Logger logger) {
		this.logger = logger;
	}

	public Reissue(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public Reissue(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
