...
public class Smallcaps extends SingleCollection<Converter>{

	protected Logger logger;
	
	private static final String title = "Smallcaps";
	
	public Smallcaps(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public Smallcaps(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public Smallcaps(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
