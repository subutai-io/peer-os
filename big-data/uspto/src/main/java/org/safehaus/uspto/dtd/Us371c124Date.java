...
public class Us371c124Date implements Converter{

	private static final String title = "Us371c124Date";
	
	protected Logger logger;

	private String date;
	
	public Us371c124Date(Logger logger) {
		this.logger = logger;
	}
	
	public Us371c124Date(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public Us371c124Date(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
