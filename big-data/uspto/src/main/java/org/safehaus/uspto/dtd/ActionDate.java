...
public class ActionDate implements Converter{

	private static final String title = "ActionDate";
	
	protected Logger logger;

	private String date;
	
	public ActionDate(Logger logger) {
		this.logger = logger;
	}
	
	public ActionDate(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public ActionDate(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
