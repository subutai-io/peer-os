...
public class AbstractSolution  extends SingleCollection<Paragraph>{

	protected Logger logger;
	
	private static final String title = "AbstractSolution";
	
	public AbstractSolution(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public AbstractSolution(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public AbstractSolution(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
