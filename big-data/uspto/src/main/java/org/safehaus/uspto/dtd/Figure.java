...
public class Figure implements Converter{

	private static final String title = "Figure";
	...
	public Figure(Logger logger) {
		this.logger = logger;
	}
	
	public Figure(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public Figure(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
