...
public class UsClaimStatement extends SingleCollection<Converter>{

	private static final String title = "UsClaimStatement";
	
	protected Logger logger;

	public UsClaimStatement(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public UsClaimStatement(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public UsClaimStatement(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
