...
public class ClassificationIpcrs extends SingleCollection<ClassificationIpcr>{

	private static final String title = "ClassificationIpcrs";
	
	protected Logger logger;
	
	public ClassificationIpcrs(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public ClassificationIpcrs(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
