...
public class DescriptionOfDrawings extends SingleCollection<Converter>{

	private static final String title = "DescriptionOfDrawings";
	
	protected Logger logger;
	
	public DescriptionOfDrawings(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public DescriptionOfDrawings(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public DescriptionOfDrawings(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
