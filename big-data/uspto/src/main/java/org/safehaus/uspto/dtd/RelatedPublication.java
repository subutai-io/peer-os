...
public class RelatedPublication implements Converter{

	private static final String title = "RelatedPublication";
	
	protected Logger logger;
	
	private DocumentId documentId;
	
	public RelatedPublication(Logger logger) {
		this.logger = logger;
	}

	public RelatedPublication(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public RelatedPublication(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
