...
public class Subscript2 extends SingleCollection<Converter>{

	protected Logger logger;
	
	private static final String title = "Subscript2";
	
	public Subscript2(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public Subscript2(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public Subscript2(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
