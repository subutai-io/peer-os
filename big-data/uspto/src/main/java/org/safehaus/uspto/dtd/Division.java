...
public class Division implements Converter{
	...
	public Division(Logger logger) {
		this.logger = logger;
	}

	public Division(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public Division(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
