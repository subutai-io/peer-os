...
public class Inventor implements Converter{

	private static final String title = "Inventor";
	...
	public Inventor(Logger logger) {
		this.logger = logger;
	}
	
	public Inventor(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public Inventor(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
