...
public class OtherCit extends SingleCollection<Converter>{

	protected Logger logger;
	
	private static final String title = "OtherCit";
	
	public OtherCit(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public OtherCit(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
