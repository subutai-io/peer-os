...
public class ListItem extends SingleCollection<Converter>{

	private static final String title = "ListItem";
	...
	public ListItem(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public ListItem(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
