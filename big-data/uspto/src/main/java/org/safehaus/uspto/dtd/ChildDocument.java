...
public class ChildDocument implements Converter{

	private static final String title = "ChildDoc";
	
	protected Logger logger;
	
	private DocumentId documentId;
	
	public ChildDocument(Logger logger) {
		this.logger = logger;
	}
	
	public ChildDocument(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public ChildDocument(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
