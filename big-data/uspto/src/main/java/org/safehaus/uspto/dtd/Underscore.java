...
public class Underscore extends SingleCollection<Converter>{

	protected Logger logger;
	
	private static final String title = "Underscore";

	private String style;

	public Underscore(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public Underscore(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public Underscore(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
