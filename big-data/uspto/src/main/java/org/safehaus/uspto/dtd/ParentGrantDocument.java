...
public class ParentGrantDocument implements Converter{

	private static final String title = "ParentGrantDocument";
	
	protected Logger logger;
	
	private DocumentId documentId;
	
	public ParentGrantDocument(Logger logger) {
		this.logger = logger;
	}

	public ParentGrantDocument(Element element, Logger logger)
	{
		this.logger = logger;
	...
	public ParentGrantDocument(org.jdom2.Element element, Logger logger)
	{
		this.logger = logger;
