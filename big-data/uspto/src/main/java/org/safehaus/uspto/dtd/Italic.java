...
public class Italic extends SingleCollection<Converter>{

	protected Logger logger;
	
	private static final String title = "Italic";
	
	public Italic(Logger logger) {
		super();
		this.logger = logger;
	}
	
	public Italic(Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
	...
	public Italic(org.jdom2.Element element, Logger logger)
	{
		super(element);
		this.logger = logger;
