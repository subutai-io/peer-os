...
public class CommandFactory {
    ...
    public static ICommand createResponse(ResponseType type, String uuid, String source, Integer exitCode, String stdOut, String stdErr, Long reqSeqNum, Long resSeqnum, Integer pid, String macAddress, String hostname) {
