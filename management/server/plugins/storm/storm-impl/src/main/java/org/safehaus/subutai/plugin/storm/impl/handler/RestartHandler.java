...
public class RestartHandler extends AbstractHandler
{
    ...
    public RestartHandler( StormImpl manager, String clusterName, String hostname )
    {
        ...
        this.trackerOperation =
                manager.getTracker().createTrackerOperation( StormClusterConfiguration.PRODUCT_NAME, "Restart node " + hostname );
    }
        ...
        for ( StormService service : services )
        {
            ...
            while( iterator.hasNext() ) {
                ...
                try
                {
                    ...
                    po.addLog( String.format( "Storm %s %s restarted on %s", service, commandResult.hasSucceeded() ? "" : "not",
