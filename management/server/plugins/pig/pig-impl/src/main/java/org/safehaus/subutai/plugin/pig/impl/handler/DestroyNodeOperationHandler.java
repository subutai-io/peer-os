...
//
//
//    public DestroyNodeOperationHandler( PigImpl manager, String clusterName, ContainerHost containerHost )
//    {
//        super( manager, clusterName );
//        this.containerHost = containerHost;
//        trackerOperation = manager.getTracker().createTrackerOperation( PigConfig.PRODUCT_KEY,
//                String.format( "Destroying %s in %s", containerHost.getHostname(), clusterName ) );
//    }
//
//
//    @Override
