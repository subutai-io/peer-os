...
public class AddNodeWindow extends Window
{
                          ...
                          final PigConfig config, Set<ContainerHost> nodes )
    {
        ...
        hadoopNodes.setId( "PigAddHadoopNodes" );
        ...
        addNodeBtn.setId( "PigAddNodesButton" );
            ...
            public void buttonClick( Button.ClickEvent clickEvent )
            {
                ...
                executorService.execute( new Runnable()
                {
                    ...
                    public void run()
                    {
                        while ( track )
                        {
                            TrackerOperationView po = tracker.getTrackerOperation( PigConfig.PRODUCT_KEY, trackID );
                            if ( po != null )
                            {
                                setOutput(
                                        po.getDescription() + "\nState: " + po.getState() + "\nLogs:\n" + po.getLog() );
