...
public class RestService {
    ...
    @Path("clusters/{clusterName}/nodes/{lxcHostName}/worker")
    @Produces({MediaType.APPLICATION_JSON})
    public Response destroyWorkerNode(
            @PathParam("clusterName") String clusterName,
            @PathParam("lxcHostName") String lxcHostName) {
        String operationId = JsonUtil.toJson(OPERATION_ID, prestoManager.destroyWorkerNode(clusterName, lxcHostName));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
    ...
    @Produces({MediaType.APPLICATION_JSON})
    public Response changeCoordinatorNode(
            @PathParam("clusterName") String clusterName,
            @PathParam("lxcHostName") String lxcHostName) {
        String operationId = JsonUtil.toJson(OPERATION_ID, prestoManager.changeCoordinatorNode(clusterName, lxcHostName));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
