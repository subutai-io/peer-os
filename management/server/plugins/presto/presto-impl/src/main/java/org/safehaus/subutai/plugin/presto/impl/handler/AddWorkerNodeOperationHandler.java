...
public class AddWorkerNodeOperationHandler extends AbstractOperationHandler<PrestoImpl>
{
    ...
    private Agent addHost( PrestoClusterConfig config ) throws LxcCreateException, ClusterSetupException
    {

        Set<Agent> set = manager.getContainerManager().clone( PrestoClusterConfig.TEMAPLTE_NAME, 1, null );
        if ( set.isEmpty() )
        {
