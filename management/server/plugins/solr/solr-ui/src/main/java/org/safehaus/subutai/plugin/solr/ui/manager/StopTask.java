...
public class StopTask implements Runnable
{
    ...
    public StopTask( Solr solr, Tracker tracker, String clusterName, ContainerHost containerHost, CompleteEvent completeEvent )
    {
        this.solr = solr;
    ...
    public void run()
    {
        ...
        UUID trackID = solr.stopNode( clusterName, containerHost );
