...
public class DestroyNodeOperationHandler extends AbstractOperationHandler<HipiImpl>
{
    private final String lxcHostname;


    public DestroyNodeOperationHandler( HipiImpl manager, String clusterName, String lxcHostname )
    {
