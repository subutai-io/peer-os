...
public class DestroyNodeHandlerTest {
    ...
    public void testNodeNotConnected(){
        ...
        DestroyNodeHandler checkHandler = new DestroyNodeHandler( sqoopImplMock.getSqoopImplConfiguredMock(), "test", po );
    ...
    public void testNodeDoesNotBelong(){
        ...
        config.setHadoopClusterName( "test" );
        sqoopImplMock.setSqoopConfig( config );
        DestroyNodeHandler checkHandler = new DestroyNodeHandler( sqoopImplMock.getSqoopImplConfigurationNotBelongToSqoopNodes(), "test", po );
