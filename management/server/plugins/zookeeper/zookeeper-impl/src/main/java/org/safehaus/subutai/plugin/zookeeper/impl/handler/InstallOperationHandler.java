...
// */
//public class InstallOperationHandler extends AbstractOperationHandler<ZookeeperImpl, ZookeeperClusterConfig>
//{
...
//                    manager.getHadoopManager().getClusterSetupStrategy( env, hadoopClusterConfig, trackerOperation);
