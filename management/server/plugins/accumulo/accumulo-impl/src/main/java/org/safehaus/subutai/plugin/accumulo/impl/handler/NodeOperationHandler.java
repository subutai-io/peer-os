...
public class NodeOperationHandler extends AbstractOperationHandler<AccumuloImpl, AccumuloClusterConfig>
{
    ...
    public NodeOperationHandler( final AccumuloImpl manager, final String clusterName, final String hostname,
...
//                        AccumuloClusterConfig.PRODUCT_KEY + " is installed on node " + host.getHostname() + " successfully." );
//            }
//            else
//            {
//                trackerOperation.addLogFailed( "Could not install " + AccumuloClusterConfig.PRODUCT_KEY + " to node " + hostname );
//            }
//        }
//        catch ( CommandException e )
//        {
...
//                manager.getPluginDAO().saveInfo( AccumuloClusterConfig.PRODUCT_KEY, config.getClusterName(), config );
//                trackerOperation.addLog(
//                        AccumuloClusterConfig.PRODUCT_KEY + " is uninstalled from node " + host.getHostname() + " successfully." );
//            }
//            else
//            {
//                trackerOperation
//                        .addLogFailed( "Could not uninstall " + AccumuloClusterConfig.PRODUCT_KEY + " from node " + hostname );
//            }
//        }
//        catch ( CommandException e )
//        {
