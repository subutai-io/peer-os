...
public class RestService {
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    public String addSlaveNode( @PathParam("clusterName") String clusterName,
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    public String destroySlaveNode( @PathParam("clusterName") String clusterName,
                                    @PathParam("lxcHostName") String lxcHostName ) {
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    public String changeMasterNode( @PathParam("clusterName") String clusterName,
                                    @PathParam("lxcHostName") String lxcHostName,
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    public String startNode( @PathParam("clusterName") String clusterName, @PathParam("lxcHostName") String lxcHostName,
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    public String stopNode( @PathParam("clusterName") String clusterName, @PathParam("lxcHostName") String lxcHostName,
                            @PathParam("master") boolean master ) {
