...
public class Commands extends CommandsSingleton
{
    ...
    public static Command getInstallCommand( Set<Agent> agents )
    {
        return createCommand(
            new RequestBuilder( "sleep 20; apt-get --force-yes --assume-yes install ksks-spark" )
    ...
    {
        return createCommand(
            new RequestBuilder( String.format( ". /etc/profile && sparkMasterConf.sh clear ; sparkMasterConf.sh %s",
