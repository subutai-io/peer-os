...
public class VerificationStep extends VerticalLayout
{
    ...
    public VerificationStep( final Jetty jetty, final ExecutorService executorService, final Tracker tracker,
                             final Wizard wizard )
    {
        ...
        install.addClickListener( new Button.ClickListener()
        {
            ...
            {
                UUID trackID = jetty.installCluster( wizard.getConfig() );
