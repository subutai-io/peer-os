...
public class RestServiceImpl implements RestService {
    ...
    public Response statusSecondaryNameNode(String clusterName) {
        HadoopClusterConfig hadoopClusterConfig = hadoopManager.getCluster(clusterName);
        String operationId = JsonUtil.toJson(OPERATION_ID, hadoopManager.statusSecondaryNameNode(hadoopClusterConfig));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
    ...
    public Response statusDataNode(String clusterName, String hostname) {
        ...
        String operationId = JsonUtil.toJson(OPERATION_ID, hadoopManager.statusDataNode(hadoopManager.getCluster(clusterName), agent));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
    ...
    public Response statusTaskTracker(String clusterName, String hostname) {
        Agent agent = agentManager.getAgentByHostname(hostname);
        HadoopClusterConfig hadoopClusterConfig = hadoopManager.getCluster(clusterName);
        String operationId = JsonUtil.toJson(OPERATION_ID, hadoopManager.statusTaskTracker(hadoopClusterConfig, agent));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
    ...
    public Response blockTaskTracker(String clusterName, String lxcHostName) {
        ...
        String operationId = JsonUtil.toJson(OPERATION_ID, hadoopManager.blockTaskTracker(hadoopClusterConfig, agent));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
    ...
    public Response unblockDataNode(String clusterName, String lxcHostName) {
        ...
        String operationId = JsonUtil.toJson(OPERATION_ID, hadoopManager.unblockDataNode(hadoopClusterConfig, agent));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
    ...
    public Response unblockTaskTracker(String clusterName, String lxcHostName) {
        ...
        String operationId = JsonUtil.toJson(OPERATION_ID, hadoopManager.unblockTaskTracker(hadoopClusterConfig, agent));
        return Response.status(Response.Status.OK).entity(operationId).build();
    }
}
