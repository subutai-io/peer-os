...
//        {
//            trackerOperation.addLogDone( String.format( "NameNode on %s started", node.getHostname() ) );
//        }
//        else
//        {
//            trackerOperation.addLogFailed( String.format( "Failed to start NameNode %s. %s", node.getHostname(),
