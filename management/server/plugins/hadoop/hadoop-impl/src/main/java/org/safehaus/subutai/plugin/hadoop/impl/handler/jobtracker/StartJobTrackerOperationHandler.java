...
//        {
//            trackerOperation.addLogDone( String.format( "JobTracker on %s started", node.getHostname() ) );
//        }
//        else
//        {
//            trackerOperation.addLogFailed( String.format( "Failed to start JobTracker %s. %s", node.getHostname(),
