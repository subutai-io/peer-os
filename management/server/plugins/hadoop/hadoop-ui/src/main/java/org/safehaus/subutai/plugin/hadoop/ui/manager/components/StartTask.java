...
public class StartTask implements Runnable
{
    ...
    public StartTask( Hadoop hadoop, Tracker tracker, NodeType nodeType, HadoopClusterConfig hadoopClusterConfig,
    ...
    public void run()
    {
        ...
        if ( agent != null )
        {
            ...
            {
                trackID = hadoop.startDataNode( hadoopClusterConfig, agent.getHostname() );
            }
            else
            {
                trackID = hadoop.startTaskTracker( hadoopClusterConfig, agent.getHostname() );
            }
