...
public class DestroyCfgSrvCallback implements TaskCallback {
    ...
    public DestroyCfgSrvCallback(Window parentWindow, Config config, Agent nodeAgent, Table cfgSrvTable, Table routersTable, Object rowId, Operation op, TaskRunner taskRunner, Embedded progressIcon, Button checkButton, Button startButton, Button stopButton, Button destroyButton) {
