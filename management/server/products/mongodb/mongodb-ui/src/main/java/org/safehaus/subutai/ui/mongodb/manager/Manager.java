                ...
                if ( config != null )
                {
                    ...
                    alert.getOk().addClickListener( new Button.ClickListener()
                    {
                        ...
                        public void buttonClick( Button.ClickEvent clickEvent )
                        {
                            ...
                            ProgressWindow window = new ProgressWindow( MongoUI.getExecutor(), MongoUI.getTracker(),
                    ...
                    alert.getOk().addClickListener( new Button.ClickListener()
                    {
                        ...
                        public void buttonClick( Button.ClickEvent clickEvent )
                        {
                            UUID trackID = MongoUI.getMongoManager()
                                .addNode( config.getClusterName(), NodeType.ROUTER_NODE );
                            ProgressWindow window = new ProgressWindow( MongoUI.getExecutor(), MongoUI.getTracker(),
                                trackID, Config.PRODUCT_KEY );
                            window.getWindow().addCloseListener( new Window.CloseListener()
                            {
            ...
            public void buttonClick( Button.ClickEvent clickEvent )
            {
                if ( config != null )
                {
                    ...
                    alert.getOk().addClickListener( new Button.ClickListener()
                    {
                        ...
                        {
                            UUID trackID = MongoUI.getMongoManager()
                                .addNode( config.getClusterName(), NodeType.DATA_NODE );
                            ProgressWindow window = new ProgressWindow( MongoUI.getExecutor(), MongoUI.getTracker(),
                                trackID, Config.PRODUCT_KEY );
                            window.getWindow().addCloseListener( new Window.CloseListener()
                            {
                ...
                if ( event.isDoubleClick() )
                {
                    ...
                    if ( lxcAgent != null )
                    {
                        TerminalWindow terminal = new TerminalWindow( Sets.newHashSet( lxcAgent ),
                            MongoUI.getExecutor(), MongoUI.getCommandRunner(), MongoUI.getAgentManager() );
            ...
            startBtn.addClickListener( new Button.ClickListener()
            {
                ...
                public void buttonClick( Button.ClickEvent clickEvent )
                {
                    ...
                    MongoUI.getExecutor().execute(
                        new StartTask( nodeType, config.getClusterName(), agent.getHostname(), new CompleteEvent()
                        {
