    ...
    public StepSetMaster(final Wizard wizard) {
        ...
        next.addListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                wizard.getConfig().setMaster((Agent) selectMaster.getValue());
        ...
        selectMaster.setContainerDataSource(new BeanItemContainer<Agent>(Agent.class, wizard.getConfig().getNodes()));
