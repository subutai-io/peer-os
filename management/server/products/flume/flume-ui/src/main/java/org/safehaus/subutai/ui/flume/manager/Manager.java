                ...
                if ( event.isDoubleClick() )
                {
                    ...
                    if ( lxcAgent != null )
                    {
                        TerminalWindow terminal = new TerminalWindow( Sets.newHashSet( lxcAgent ),
                            FlumeUI.getExecutor(), FlumeUI.getCommandRunner(), FlumeUI.getAgentManager() );
                ...
                if ( config != null )
                {
                    ...
                    alert.getOk().addClickListener( new Button.ClickListener()
                    {
                        ...
                        public void buttonClick( Button.ClickEvent clickEvent )
                        {
                            ...
                            ProgressWindow window = new ProgressWindow( FlumeUI.getExecutor(), FlumeUI.getTracker(),
    ...
    private void getAddNodeButton( HorizontalLayout controlsContent )
    {
        ...
        addNodeBtn.addClickListener( new Button.ClickListener()
        {
            ...
            public void buttonClick( Button.ClickEvent clickEvent )
            {
                if ( config != null )
                {
                    org.safehaus.subutai.api.hadoop.Config info = FlumeUI.getHadoopManager()
        ...
        for ( final Agent agent : agents )
        {
            ...
            startBtn.addClickListener( new Button.ClickListener()
            {
                ...
                public void buttonClick( Button.ClickEvent clickEvent )
                {
                    ...
                    ProgressWindow window = new ProgressWindow( FlumeUI.getExecutor(), FlumeUI.getTracker(), trackID,
                        Config.PRODUCT_KEY );
                    window.getWindow().addCloseListener( new Window.CloseListener()
                    {
                        @Override
            ...
            destroyBtn.addClickListener( new Button.ClickListener()
            {
                ...
                public void buttonClick( Button.ClickEvent clickEvent )
                {
                    ...
                    alert.getOk().addClickListener( new Button.ClickListener()
                    {
                        ...
                        public void buttonClick( Button.ClickEvent clickEvent )
                        {
                            UUID trackID = FlumeUI.getManager()
