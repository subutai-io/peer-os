...
public class Manager {
	...
	public Manager() {
		...
		addNodeBtn.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(Button.ClickEvent clickEvent) {
				if (config != null) {
					org.safehaus.subutai.api.hadoop.Config hadoopConfig = MahoutUI.getHadoopManager().getCluster(config.getClusterName());
		...
		table.addItemClickListener(new ItemClickEvent.ItemClickListener() {
			...
			public void itemClick(ItemClickEvent event) {
				if (event.isDoubleClick()) {
					...
					if (lxcAgent != null) {
						TerminalWindow terminal = new TerminalWindow(Util.wrapAgentToSet(lxcAgent), MahoutUI.getExecutor(), MahoutUI.getCommandRunner(), MahoutUI.getAgentManager());
