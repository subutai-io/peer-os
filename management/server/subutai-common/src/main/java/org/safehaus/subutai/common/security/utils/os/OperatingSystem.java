...
public class OperatingSystem
{
	...
	{
		return ( osName.indexOf( "Windows NT" ) > -1 )
		        && ( osVersion.equals( "4.0" ) );
	}
	...
	{
		return ( osName.indexOf( "Windows 95" ) > -1 )
		        && ( osVersion.equals( "4.0" ) );
	}
	...
	{
		return ( osName.indexOf( "Windows" ) > -1 )
		        && ( osVersion.equals( "6.2" ) || osVersion.equals( "6.3" ) );
	}
	...
	{
		return isSolaris() || isAix() || isFreeBsd() || isHpUx() || isIrix()
		        || isDigitalUnix();
	}
	...
	{
		return !isWindows() && !isLinux() && !isMacOs() && !isUnix()
		        && !isOs2();
	}
}
