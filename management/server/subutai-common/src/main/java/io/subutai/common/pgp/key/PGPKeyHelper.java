package io.subutai.common.pgp.key;
...
public class PGPKeyHelper
{
    ...
    public static PGPPrivateKey readPrivateKey( InputStream is, char[] password ) throws PGPException, IOException
    {
        PGPSecretKey secretKey = readSecretKey( is );
    ...
    public static PGPPrivateKey readPrivateKey( String filePath, char[] password ) throws PGPException, IOException
    {
        PGPPrivateKey privateKey;
    ...
    public static PGPPrivateKey readPrivateKey( final String filePath,
                                                final PasswordCallback privateKeyPasswordCallback )

            throws PGPException, IOException
    {
        PGPPrivateKey result = readPrivateKey( filePath, privateKeyPasswordCallback.getPassword() );
