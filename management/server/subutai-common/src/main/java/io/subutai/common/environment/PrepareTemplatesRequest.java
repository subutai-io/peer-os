...
public class PrepareTemplatesRequest
{
    ...
    public PrepareTemplatesRequest( final String hostname, final String environmentId, final String initiatorPeerId,
                                    final String ownerId, final String subnetCidr, final int ipAddressOffset,
