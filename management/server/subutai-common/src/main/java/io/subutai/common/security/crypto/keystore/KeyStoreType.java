...
import static io.subutai.common.security.crypto.file.CryptoFileType.BKS_KS;
import static io.subutai.common.security.crypto.file.CryptoFileType.BKS_V1_KS;
import static io.subutai.common.security.crypto.file.CryptoFileType.JCEKS_KS;
import static io.subutai.common.security.crypto.file.CryptoFileType.JKS_KS;
import static io.subutai.common.security.crypto.file.CryptoFileType.PKCS12_KS;
import static io.subutai.common.security.crypto.file.CryptoFileType.UBER_KS;
...
public enum KeyStoreType
{
    ...
    JKS( "JKS", true, JKS_KS ), JCEKS( "JCEKS", true, JCEKS_KS ), PKCS12( "PKCS12", true, PKCS12_KS ),
    BKS_V1( "BKS-V1", true, BKS_V1_KS ), BKS( "BKS", true, BKS_KS ), UBER( "UBER", true, UBER_KS ),
    KEYCHAIN( "KeychainStore", false, null ), MS_CAPI_PERSONAL( "Windows-MY", false, null ),
    MS_CAPI_ROOT( "Windows-ROOT", false, null ), PKCS11( "PKCS11", false, null );
    ...
    KeyStoreType( String jce, boolean fileBased, CryptoFileType cryptoFileType )
    {
        this.jce = jce;
