...
public class Timeouts
{
    ...
    public static final int CREATE_CONTAINER_RESPONSE_TIMEOUT = 5 * 60 * 60; // 5 hours for containers clone
    public static final int PREPARE_TEMPLATES_REQUEST_TIMEOUT = 3 * 60;
    public static final int PREPARE_TEMPLATES_RESPONSE_TIMEOUT = 10 * 60 * 60; // 10 hours for template import
