 ...
 */
public class NetValueResourceParser implements ResourceValueParser
{
    ...
    private static NetValueResourceParser instance;


    private NetValueResourceParser()
    {
    }


    public static NetValueResourceParser getInstance()
    {

        if ( instance == null )
        {
            instance = new NetValueResourceParser();
        }
        return instance;
    }
