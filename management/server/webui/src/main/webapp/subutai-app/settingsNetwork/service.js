...
function SettingsNetworkSrv($http) {
    ...
    function updateConfig(config) {
        var postData = "&securePortX1=" + config.securePortX1 + "&securePortX2=" + config.securePortX2 + "&securePortX3=" + config.securePortX3 + "&publicUrl=" + config.publicUrl + "&agentPort=" + config.agentPort;
        return $http.post(
