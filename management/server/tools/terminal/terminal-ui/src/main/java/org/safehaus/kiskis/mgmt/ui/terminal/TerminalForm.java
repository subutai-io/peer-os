...
public class TerminalForm extends CustomComponent {
    ...
    public static Request getRequestTemplate() {
        return CommandFactory.newRequest(RequestType.EXECUTE_REQUEST, null, TerminalUI.MODULE_NAME, null, 1, "/", "pwd", OutputRedirection.RETURN, OutputRedirection.RETURN, null, null, "root", null, null, 30); //
    }
