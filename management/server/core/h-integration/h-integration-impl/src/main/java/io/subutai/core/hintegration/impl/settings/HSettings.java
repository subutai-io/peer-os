...
public class HSettings
{
    ...
    public static final String PEER_OWNER_PUB_KEY = Common.SUBUTAI_APP_DATA_PATH + "/hkeystore/peer.owner.public.gpg";
    public static final String PEER_OWNER_SECRET_KEY = Common.SUBUTAI_APP_DATA_PATH + "/hkeystore/peer.owner.secret.gpg";
