...
//                               .entity( String.format( "%s already registered", remotePeerInfo.getName() ) ).build();
//            }
//            else
//            {
...
//        {
//            String baseUrl =
//                    String.format( "https://%s:%s/rest/v1/peer/register", peerIp, ChannelSettings.SECURE_PORT_X1 );
