...
/**
 * The Integer fields of PeerPolicy class is autogenerated in this window
 * TODO If types other than Integer need to be added, then this window should be extended to support them
 */
