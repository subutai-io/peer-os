package org.safehaus.subutai.peer.ui.forms;
...
public class PeerRegisterForm extends CustomComponent {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(absoluteLayout_2,
				"top:20.0px;right:0.0px;bottom:-20.0px;left:0.0px;");
	...
	private AbsoluteLayout buildAbsoluteLayout_2() {
		...
		absoluteLayout_2
				.addComponent(nameTextField, "top:36.0px;left:100.0px;");
		...
		absoluteLayout_2.addComponent(registerButton,
				"top:160.0px;left:20.0px;");
		...
		absoluteLayout_2.addComponent(showPeersButton,
				"top:234.0px;left:20.0px;");
