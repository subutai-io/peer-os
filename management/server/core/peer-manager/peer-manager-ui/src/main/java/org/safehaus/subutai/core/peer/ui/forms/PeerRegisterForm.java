...
public class PeerRegisterForm extends CustomComponent {
    ...
    private final static Logger LOG = Logger.getLogger( PeerRegisterForm.class.getName() );
    ...
    private AbsoluteLayout buildAbsoluteLayout_2() {
        ...
        absoluteLayout_2.addComponent( registerButton, "top:160.0px;left:20.0px;" );registerButton = createRegisterButton();
        registerViaRestButton = createRegisterViaRestButton();
        absoluteLayout_2.addComponent( registerViaRestButton, "top:160.0px;left:220.0px;" );
...
//                peersTable.setContainerDataSource( ds );
    ...
    private Button createRegisterViaRestButton() {
        registerButton = new Button();
        registerButton.setCaption( "REST Register" );
        registerButton.setImmediate( true );
        registerButton.setWidth( "-1px" );
        registerButton.setHeight( "-1px" );
