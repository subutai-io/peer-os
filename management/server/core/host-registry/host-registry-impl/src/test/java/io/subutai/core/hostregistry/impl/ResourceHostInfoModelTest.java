...
public class ResourceHostInfoModelTest
{
    ...
    {
        resourceHostInfo = JsonUtil.fromJson( INFO_JSON, ResourceHostInfoModel.class );
    }
    ...
    public void testEqualsHashCode() throws Exception
    {
        ...
        //check equals
        ResourceHostInfo resourceHostInfo2 = JsonUtil.fromJson( INFO_JSON, ResourceHostInfoModel.class );

        assertEquals( resourceHostInfo, resourceHostInfo2 );

        assertFalse( resourceHostInfo.equals( new Object() ) );

        ResourceHostInfo resourceHostInfo3 = JsonUtil.fromJson( INFO2_JSON, ResourceHostInfoModel.class );
