 ...
 */
public class GetPhysicalAgentsCommandTest
{
    ...
    {
        new GetPhysicalAgentsCommand( null );
    }
    ...
    public void shouldReturnAgents()
    {
        ...
        GetPhysicalAgentsCommand getPhysicalAgentsCommand = new GetPhysicalAgentsCommand( agentManager );
        getPhysicalAgentsCommand.doExecute();
