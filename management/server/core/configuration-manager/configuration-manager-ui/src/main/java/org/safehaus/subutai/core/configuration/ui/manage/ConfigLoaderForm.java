...
public class ConfigLoaderForm extends CustomComponent
{
     ...
     */
    public ConfigLoaderForm( ConfigurationManager configurationManager )
    {
    ...
    private HorizontalLayout buildHorizontalLayout1()
    {
        ...
        for ( ConfiguraitonTypeEnum anEnum : ConfiguraitonTypeEnum.values() )
        {
        ...
        // button1
        button1 = new ConvertToJsonButton( this.configurationManager );
        buttonInject = new InjectIntoLxcButton( this.configurationManager );
    ...
    private class ConvertToJsonButton extends Button
    {
        ...
        private ConvertToJsonButton( final ConfigurationManager configurationManager )
        {
            ...
            addClickListener( new Button.ClickListener()
            {
                ...
                public void buttonClick( final Button.ClickEvent clickEvent )
                {
                    ...
                    ConfiguraitonTypeEnum typeEnum = ( ConfiguraitonTypeEnum ) comboBox2.getValue();

                    JsonObject configStr = configurationManager.getJsonObjectFromResources( configPath, typeEnum );
    ...
    private class InjectIntoLxcButton extends Button
    {
        ...
        private InjectIntoLxcButton( final ConfigurationManager configurationManager )
        {
            ...
            addClickListener( new Button.ClickListener()
            {
                ...
                public void buttonClick( final Button.ClickEvent clickEvent )
                {
                    ...
                    configurationManager.injectConfiguration( hostname, configPath, config, typeEnum );
                }
            } );
        }
    }
