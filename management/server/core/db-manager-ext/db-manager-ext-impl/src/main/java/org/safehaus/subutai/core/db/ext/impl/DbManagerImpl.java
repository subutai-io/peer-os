...
public class DbManagerImpl implements DbManager
{
    ...
    public void init()
    {
        ...
        try
        {
            LOG.info( "DbManager: Starting Persistence Factory initialization." );

            /*
            final String PERSISTENCE_UNIT_NAME = "DbManagerH2";

            Map<String,Object> properties = new HashMap<String, Object>();
            properties.put( PersistenceUnitProperties.CLASSLOADER, this.getClass().getClassLoader());
            entFactory = Persistence.createEntityManagerFactory(PERSISTENCE_UNIT_NAME, properties);
