...
/**
 * This is a cache with entries having time-to-live setting. After the specified
 * interval entry gets evicted (expires). It is possible to add expiry callback
 * to an entry to handle the expiration event
 *
 * @author dilshat
 */
