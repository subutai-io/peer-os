...
public class CommandCallback {
     ...
     * @param agentResult - the cumulated result from an agent which sent this
     * response
    ...
    /**
     * Causes the call to runCommand to return, associated callback (if any) no
     * longer receives responses from agent even (if any). Command status is not
