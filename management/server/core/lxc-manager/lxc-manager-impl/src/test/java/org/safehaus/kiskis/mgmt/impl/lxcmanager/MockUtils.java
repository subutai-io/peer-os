...
public class MockUtils {
    ...
    public static Command getCommand(boolean completed, boolean succeeded, Integer exitCode, String stdOut, String stdErr) {
        ...
        Map<UUID, AgentResult> results = new HashMap<UUID, AgentResult>();
    ...
    public static CommandRunner getAutoCommandRunner() {
        ...
        when(commandRunner.createCommand(any(RequestBuilder.class), any(Set.class))).thenAnswer(new Answer<Command>() {
    ...
    public static CommandRunner getHardCodedCommandRunner(boolean completed, boolean succeeded, Integer exitCode, String stdOut, String stdErr) {
        CommandRunner commandRunner = mock(CommandRunner.class);
