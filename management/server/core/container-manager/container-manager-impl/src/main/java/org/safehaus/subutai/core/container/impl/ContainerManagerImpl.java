...
public class ContainerManagerImpl extends ContainerManagerBase {
    private static final java.util.logging.Logger LOG =
            java.util.logging.Logger.getLogger( ContainerManagerImpl.class.getName() );
    ...
    //        return bestServers;
    //    }
    //    public Map<Agent, Integer> getPlacementDistribution(AbstractContainerPlacementStrategy strategy,
    // int nodesCount) throws ContainerCreateException {
