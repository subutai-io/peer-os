...
import org.safehaus.subutai.core.container.ui.executor.*;
...
public class Cloner extends VerticalLayout implements AgentExecutionListener {
    ...
    Map<ContainerPlacementStrategy, BeanItemContainer<Criteria>> criteriaBeansMap = new HashMap<ContainerPlacementStrategy, BeanItemContainer<Criteria>>();
