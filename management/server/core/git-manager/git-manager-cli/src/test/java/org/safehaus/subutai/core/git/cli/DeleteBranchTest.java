...
public class DeleteBranchTest
{
    ...
    {
        new DeleteBranch( null, mock( AgentManager.class ) );
    }
    ...
    {
        new DeleteBranch( mock( GitManager.class ), null );
    }
    ...
    {
        DeleteBranch deleteBranch = new DeleteBranch( mock( GitManager.class ), mock( AgentManager.class ) );
    ...
    public void shouldExecuteCommand() throws GitException
    {
        ...
        DeleteBranch deleteBranch = new DeleteBranch( gitManager, agentManager );
        deleteBranch.setHostname( HOSTNAME );

        deleteBranch.doExecute();

        verify( gitManager ).deleteBranch( eq( agent ), anyString(), anyString() );
    }
    ...
    public void shouldThrowException() throws GitException
    {
        Mockito.doThrow( new GitException( ERR_MSG ) ).when( gitManager )
               .deleteBranch( eq( agent ), anyString(), anyString() );
        DeleteBranch deleteBranch = new DeleteBranch( gitManager, agentManager );
        deleteBranch.setHostname( HOSTNAME );
