...
public class PushTest
{
    ...
    {
        new Push( null, mock( AgentManager.class ) );
    }
    ...
    {
        new Push( mock( GitManager.class ), null );
    }
    ...
    {
        Push push = new Push( mock( GitManager.class ), mock( AgentManager.class ) );
    ...
    public void shouldExecuteCommand() throws GitException
    {
        ...
        Push push = new Push( gitManager, agentManager );
        push.setHostname( HOSTNAME );

        push.doExecute();


        verify( gitManager ).push( eq( agent ), anyString(), anyString() );
    }
    ...
    {
        Mockito.doThrow( new GitException( ERR_MSG ) ).when( gitManager ).push( eq( agent ), anyString(), anyString() );
        Push push = new Push( gitManager, agentManager );
        push.setHostname( HOSTNAME );
