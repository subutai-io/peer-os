...
public class DeleteBranch extends SubutaiShellCommandSupport
{
    ...
    public DeleteBranch( final GitManager gitManager )
    {
    ...
    protected Object doExecute()
    {
        try
        {
            gitManager.deleteBranch( repoPath, branchName );
        }
