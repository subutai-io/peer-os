...
import org.safehaus.subutai.core.containerregistry.api.ContainerRegistryException;
 ...
 */
public class ContainerRegistryImpl implements ContainerRegistry
{
    private static final Logger LOG = LoggerFactory.getLogger( ContainerRegistryImpl.class.getName() );
