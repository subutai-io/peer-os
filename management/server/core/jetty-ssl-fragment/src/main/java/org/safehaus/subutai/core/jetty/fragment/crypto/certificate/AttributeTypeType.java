package org.safehaus.subutai.core.jetty.fragment.crypto.certificate;
...
{
    COMMON_NAME( "2.5.4.3", "CommonNameAttributeType" ), SERIAL_NUMBER( "2.5.4.5", "SerialNumberAttributeType" ),
    COUNTRY_NAME( "2.5.4.6", "CountryNameAttributeType" ), LOCALITY_NAME( "2.5.4.7", "LocalityNameAttributeType" ),
    ...
    ORGANIZATIONAL_UNIT( "2.5.4.11", "OrganizationalUnitNameAttributeType" ), TITLE( "2.5.4.12", "TitleAttributeType" ),
