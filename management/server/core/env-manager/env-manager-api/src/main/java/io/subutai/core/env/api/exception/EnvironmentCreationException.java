...
/**
 * The class {@code EnvironmentCreationException} extends class {@code Exception} Thrown if error occurred while
 * creating new environment Exception may be thrown on any event relevant to environment creation process, if some
 * conditions don't apply to target result needs.
 */
