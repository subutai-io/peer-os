...
public class EnvironmentContainerDataService implements DataService<String, EnvironmentContainerImpl>
{
    ...
    /**
     * Returns {@link io.subutai.core.env.impl.entity.EnvironmentContainerImpl} object for requested id {@link java.lang.String}
     * <p>@param id - entity id to retrieve an object from database</p>
     * <p>@return - {@link io.subutai.core.env.impl.entity.EnvironmentContainerImpl} object or {@code null} value</p>
     */
    @Override
    ...
    /**
     * Gets list of all {@link io.subutai.core.env.impl.entity.EnvironmentContainerImpl} exist in database
     * @return - {@link java.util.Collection} of {@link io.subutai.core.env.impl.entity.EnvironmentContainerImpl}
     */
    @Override
    ...
    /**
     * Save {@link io.subutai.core.env.impl.entity.EnvironmentContainerImpl} object to database <b>Warning your entity object
    ...
    /**
     * Delete {@link io.subutai.core.env.impl.entity.EnvironmentContainerImpl} from database by {@link java.lang.String} key
    ...
    /**
     * Update {@link io.subutai.core.env.impl.entity.EnvironmentContainerImpl} entity saved in database
