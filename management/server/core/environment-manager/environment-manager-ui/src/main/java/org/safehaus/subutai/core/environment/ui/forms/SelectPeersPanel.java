...
import org.safehaus.subutai.core.environment.ui.manage.WizardWindow;
...
public class SelectPeersPanel extends CustomComponent {
     ...
     */
    public SelectPeersPanel( WizardWindow wizardWindow ) {
        buildMainLayout();
...
//                wizardWindow.next();
    ...
    private Button createShowPeersButton() {
        ...
        getPeersButton.addClickListener( new Button.ClickListener() {
            @Override
            public void buttonClick( final Button.ClickEvent clickEvent ) {
                List<Peer> peers = wizardWindow.getManagerUI().getPeerManager().peers();
