...
public class HostTopologyWindow extends Window
{
    private static final Logger LOG = LoggerFactory.getLogger( HostTopologyWindow.class );
    ...
    public HostTopologyWindow( final Blueprint blueprint, final PeerManager peerManager,
