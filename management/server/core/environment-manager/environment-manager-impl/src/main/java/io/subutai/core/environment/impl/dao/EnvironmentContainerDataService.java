...
/**
 * {@link EnvironmentContainerDataService} manages information about environment container in database
 */
public class EnvironmentContainerDataService implements DataService<String, EnvironmentContainerImpl>
{
    ...
    /**
     * Returns {@link io.subutai.core.environment.impl.entity.EnvironmentContainerImpl} object for requested id {@link
     * String} <p>@param id - entity id to retrieve an object from database</p> <p>@return - {@link
     * io.subutai.core.environment.impl.entity.EnvironmentContainerImpl} object or {@code null} value</p>
     */
    @Override
     ...
     *
     * @return - {@link java.util.Collection} of {@link io.subutai.core.environment.impl.entity
    ...
    /**
     * Save {@link io.subutai.core.environment.impl.entity.EnvironmentContainerImpl} object to database <b>Warning your
     * entity object key must be unique in database otherwise rollback transaction will be applied </b>
     *
    ...
    /**
     * Delete {@link io.subutai.core.environment.impl.entity.EnvironmentContainerImpl} from database by {@link String}
     * key
     *
