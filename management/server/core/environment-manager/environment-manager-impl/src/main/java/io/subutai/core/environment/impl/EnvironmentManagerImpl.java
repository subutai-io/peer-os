...
public class EnvironmentManagerImpl extends HostListener
    ...
    @Override
    public void placeTokenToContainer(String environmentId, String containerIp, String token) throws EnvironmentNotFoundException, ContainerHostNotFoundException, CommandException {
    ...
    private void placeTokenIntoContainer(ContainerHost containerHost, String token)
            throws CommandException {
        if (containerHost instanceof EnvironmentContainerImpl) {
            // workaround to disable security checks for this call
            ((EnvironmentContainerImpl) containerHost).executeUnsafe(new RequestBuilder(
