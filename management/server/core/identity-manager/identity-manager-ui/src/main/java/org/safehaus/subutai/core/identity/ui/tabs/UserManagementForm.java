...
public class UserManagementForm extends CustomComponent
{
    ...
    public UserManagementForm( IdentityManager identityManager )
    {
    ...
    void editableHeights()
    {
        ...
        final Table table = new Table( "User list" );
        ...
        table.setDescription( "All registered users." );
        ...
        for ( int i = 0; i < users.size(); i++ )
        {
            ...
            Object name = user.getFullname();
            Object login = user.getUsername();
            Object password = new PasswordField( user.getPassword() );
