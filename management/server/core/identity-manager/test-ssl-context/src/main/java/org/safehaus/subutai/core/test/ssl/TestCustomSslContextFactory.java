package org.safehaus.subutai.core.test.ssl;
...
/**
 * Created by talas on 3/4/15.
 */
public class TestCustomSslContextFactory extends SslContextFactory
{

    private static final Logger LOG = LoggerFactory.getLogger( TestCustomSslContextFactory.class );
    ...
    public TestCustomSslContextFactory()
    {
        super();
    ...
    public TestCustomSslContextFactory( final boolean trustAll )
    {
        super( trustAll );
        LOG.warn( "Subutai Ssl Factory initialized" );
    }
    ...
    public TestCustomSslContextFactory( final String keyStorePath )
    {
        super( keyStorePath );
        LOG.warn( "Subutai Ssl Factory initialized" );
    }
