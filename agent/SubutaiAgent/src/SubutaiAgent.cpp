...
int main(int argc,char *argv[],char *envp[])
{
    ...
    logMain.writeLog(6, logMain.setLogData("<SubutaiAgent>","Trying to open Connection with MQTT Broker: ",
                ...
                " Port: ",environment.getAgentConnectionPortValue()));
    ...
    sendout = response.createRegistrationMessage(environment.getAgentUuidValue(),environment.getAgentMacAddressValue()
